...
<div class="logoo">
    <?php
    if ($resultNintedo && $resultNintedo->num_rows > 0) {
        while ($row =mysqli_fetch_assoc($resultNintedo)) {
            echo '<img src="images/' . $row['image_url'] . '" alt="' .$row['category_name'] . ' Logo" width="50%" height="20%" >';
...
$current_device_name = '';
if ($resultNintedopage->num_rows > 0) {
    $index = 1;
    while ($row =$resultNintedopage->fetch_assoc()) {
